    ...
    <section class="container section services">
        ...
        <div class="services-item" id="home-design">
            <div class="services-item__text">
                ...
                <div class="services-item__text-bottom">
                    <ul>
                        <li>
...
Задача презентации — удержать внимание с помощью логической структурой повествования, <br>1 мысль — 1 слайд. </p>
                </div>
            </div>
            <div class="services-item__img">
        ...
        <!-- <div class="services-item">
            <div class="services-item__text">
                ...
                <div class="services-item__text-desc">
                    <h3>Иллюстрации</h3>
                    <p>Уникальные векторные иллюстрации в любом стиле для интерфейсов, рекламыи социальных сетей. <br>Работаю с 3D графикой в блендере.</p>
                </div>
            </div>
